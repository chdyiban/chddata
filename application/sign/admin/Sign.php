...
class Sign extends Admin
{
    ...
    public function signRateCount($group = 'tab1'){
      ...
      $data = Db::view('sign_record')
        ->view('sign_task','id,title,adminid','sign_record.task_id=sign_task.id')
        ->view('yiban_base_info','class,sex,name,college,number,admin_id,major','sign_record.stu_id=yiban_base_info.number
    ...
    public function signSpecialList(){
        ...
        // $data = Db::view('sign_record')
        //       ->view('sign_task','id,title,adminid','sign_record.task_id=sign_task.id')
        //       ->view('yiban_base_info','major,class,sex,name,college,number,admin_id','sign_record.stu_id=yiban_base_info.number
        //       AND  yiban_base_info.admin_id ='.UID)
        //       ->group('class')
        //       ->where($map)
        //       ->order($order)
